        ...
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            <Text style={{ color: "#fff" }}>
              Give us feedback to improve the app or just show your appreciation
            </Text>
          </View>
          <View style={styles.modalBody}>
            <TextInput
              value={this.state.feedbackTitle}
              placeholder="Enter Feedback Title (optional)"
            ...
            <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
              ...
              <TouchableOpacity
                style={[
                  styles.button,
                  { backgroundColor: `${MyColors.PRIMARY}`, marginLeft: 8 }
                ]}
  ...
  render() {
    return (
      <ScrollView style={styles.mainContainer}>
        <TouchableOpacity
          style={styles.option}
          onPress={() => this.props.navigation.navigate("PriceComposition")}
        >
          <Text>Learn More</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.option}
          onPress={() => this.props.navigation.navigate("PetrolPumpMap")}
        >
          <Text>Find Nearby Petrol Stations</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.option}
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Linking.openURL(
              "https://play.google.com/store/apps/details?id=com.gorro.nothing"
            )
          }
        >
