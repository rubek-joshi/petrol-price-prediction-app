...
class ForgotPassword extends Component {
  ...
  _verifyCode() {
    ...
    if (this.state.code == this.state.userCode) {
      ...
      this.loadingButton.showLoading(false);
      this.setState({
        error: "The code entered does not match the security. Please try again."
      });
    }
  }
  validateEmail() {
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ paddingHorizontal: 16, marginTop: 16 }}>
            <Text style={{ fontWeight: "bold" }}>
              Please enter your email to reset your password. A temporary secret
              code will then be sent to your email with which you can use to
              reset your password.
            </Text>
            <TextField
              tintColor={"#000"}
