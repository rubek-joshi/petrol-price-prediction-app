...
class PriceComposition extends Component {
      ...
      <View style={{ padding: 16 }}>
        ...
        >
          ...
          <Text style={{ fontWeight: "bold" }}>
            {composition.retail_price +
              composition.custom_duty +
              composition.road_maintenance +
              composition.pending_dev_tax +
              composition.pollution_fees +
              composition.price_stabilization +
              composition.VAT}
          </Text>
        </View>
        <View style={{ borderBottomWidth: StyleSheet.hairlineWidth }}>
  ...
  render() {
    return <ScrollView>{this.renderComposition()}</ScrollView>;
  }
}
